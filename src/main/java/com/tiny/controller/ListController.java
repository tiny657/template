...
public class ListController {
  ...
  public ModelAndView list(
      @RequestParam(defaultValue = "2147483647", required = false) int documentId, @RequestParam(
    ...
    for (Document document : documents) {
      ...
      comments.put(Integer.toString(document.getDocumentId()),
          commentService.get(document.getDocumentId()));
